...
class UploadHandler
{
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            {    
                $this->merge_pics($file_path,getcwd()."/logo.png");
                //$this->hs_resize(getcwd()."/logo.png",50,50,getcwd()."/logo1.png");
            }    
        }
        return $file;
    }
    ...
    public function merge_pics($filename_x, $filename_y) 
    {
...
// Create new image with desired dimensions
	...
	$image_y = imagecreatefrompng($filename_y);
        ...
        $thumb = imagecreatetruecolor((int)($width_y/2), (int)($height_y/2));
	...
	if($tmp==2)
		imagejpeg($image,$filename_x);
	else if($tmp==3)
		imagepng($image, $filename_x);
	imagedestroy($image);
	imagedestroy($image_x);
	imagedestroy($image_y);
    }
    function hs_resize($img, $w, $h, $newfilename) {
